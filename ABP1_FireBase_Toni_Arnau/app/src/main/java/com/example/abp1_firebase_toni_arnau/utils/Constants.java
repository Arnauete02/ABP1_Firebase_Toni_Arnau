...
public interface Constants {
    ...
    String[] anagrama = {"nepal-panel", "nacionalista–altisonancia", "valora-alvaro", "frase-fresa", "colinas-nicolas",
            "pagar-praga", "integrarla-iInglaterra", "quieren-enrique", "cornisa-narciso", "acuerdo-ecuador", "japones-esponja",
            "amparo-paramo", "deudora-eduardo", "ramon-norma", "camino-monica", "fotolitografia-litofotografia", "animal-lamina",
            "matar-marta", "saco-cosa", "mora-roma", "brasil-silbar", "sentido-destino", "saunas-susana", "croacia-arcaico", "tinieblas-sibilante",
            "aretes-teresa", "andalucía-alucinada", "cronista-cortinas", "ventilan-valentín", "aparcamiento-metacarpiano", "calienta-alicante",
            "trama-marta", "ballena-llenaba", "reposare-reposera", "cardiografia-radiografica", "conejo-encojo", "demostracion-domesticaron",
            "desamparador-desparramado", "polonia-opalino", "sopera-sopear", "conservadora-conversadora", "ardientemente-retenidamente",
            "aspero-espora", "ironicamente-renacimiento", "riesgo-sergio", "aires-aries", "escandalizar-zascandilear", "agonista-santiago",
            "presa-pesar", "enfriamiento-refinamiento", "calor-colar", "esta-ates", "romina-marino", "prisa-parís", "astringencia-transigencia",
            "materialismo-memorialista", "poder-pedro", "resto-retos", "energicamente-genericamente", "necrofila-florencia", "reías-riase",
            "presuposicion-superposicion", "armonía-mariano", "arte-tera", "enamoramientos-armoniosamente", "salario-rosalia", "caracas-cascara",
            "rectificable-certificable", "ovoide-oviedo", "españa-apañes", "reconquistados-conquistadores", "camelia-micaela", "alondra-ladrona",
            "escabullimiento-bulliciosamente", "enlodar-leandro", "conservacion-conversacion", "electromagnetico-magnetoelectrico", "delira-lidera",
            "derrocamiento-recordamiento", "imponderable-imperdonable", "agranda-granada", "manila-animal", "armonizacion-romanizacion", "licua-lucia",
            "ruanda-anudar", "pronosticacion-contraposicion", "amor-roma", "protesta-portaste"};
