...
public interface Constants {
    ...
    String[] anagrama = {"nepal", "panel", "nacionalista – altisonancia",
            "valora", "alvaro", "frase", "fresa", "colinas", "nicolas", "Pagar", "Praga", "Integrarla", "Inglaterra",
            "quieren", "enrique", "cornisa", "narciso", "acuerdo", "ecuador", "japones", "esponja", "amparo", "paramo", "deudora", "eduardo",
            "ramon", "Norma", "camino", "monica", "fotolitografia", "litofotografia", "Aaimal", "lamina", "matar", "marta", "saco", "cosa",
            "mora", "roma", "brasil", "silbar", "Sentido", "Destino", "saunas", "susana", "croacia", "arcaico", "tinieblas", "sibilante",
            "Aretes", "Teresa", "andalucía", "alucinada", "cronista", "cortinas", "ventilan", "valentín", "aparcamiento", "metacarpiano", "calienta", "alicante",
            "trama", "marta", "ballena", "llenaba", "reposare", "reposera", "cardiografia", "radiografica", "conejo", "encojo", "demostración", "domesticaron",
            "desamparador", "desparramado", "polonia", "opalino", "sopera", "sopear", "conservadora", "conversadora", "ardientemente", "Retenidamente", "Áspero", "Espora",
            "ironicamente", "renacimiento", "riesgo", "sergio", "aires", "aries", "Escandalizar", "Zascandilear", "agonista", "santiago", "presa", "pesar",
            "enfriamiento", "refinamiento", "calor", "colar", "esta", "ates", "romina", "marino", "prisa", "parís", "astringencia", "transigencia",
            "materialismo", "memorialista", "Poder", "Pedro", "Resto", "Retos", "energicamente", "genericamente", "necrofila", "florencia", "reías", "riase",
            "presuposicion", "superposicion", "armonía", "mariano", "terso", "teros", "enamoramientos", "armoniosamente", "Salario", "Rosalía", "Caracas", "Cáscara",
            "rectificable", "certificable", "ovoide", "oviedo", "españa", "apañes", "reconquistados", "conquistadores", "camelia", "micaela", "alondra", "ladrona",
            "escabullimiento", "bulliciosamente", "enlodar", "leandro", "conservacion", "conversacion", "electromagnetico", "magnetoelectrico", "delira", "lidera", "derrocamiento", "Recordamiento",
            "imponderable", "imperdonable", "agranda", "granada", "manila", "animal", "armonizacion", "romanizacion", "licua", "lucia", "ruanda", "anudar",
            "pronosticacion", "contraposicion", "amor", "roma", "protesta", "portaste"};
